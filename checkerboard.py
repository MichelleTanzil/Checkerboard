...
def play():
    width = 600
    height = 600
    return render_template("index.html", timesX=8, timesY=8, width=str(width) + "px", height=str(height) + "px")

@app.route("/<int:timesY>")
def playX(timesY):
    width = 600
    height = timesY * 75
    return render_template("index.html", timesX=8, timesY=timesY, width=str(width) + "px", height=str(height) + "px")

@app.route("/<int:timesX>/<int:timesY>")
def playXY(timesX, timesY):
    width = timesX * 75
    height = timesY * 75
    return render_template("index.html", timesX=timesX, timesY=timesY, width=str(width) + "px", height=str(height) + "px")
